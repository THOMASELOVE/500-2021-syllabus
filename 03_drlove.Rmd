...
knitr::include_graphics("figures/Thomas_Love.png")
```
...
I hold degrees from Columbia University in the City of New York and from the University of Pennsylvania. My dissertation adviser was Paul Rosenbaum. I am married to a brilliant woman who is an attorney at Savant Systems, and we are raising two terrific sons. The elder is a senior at the University of Pittsburgh who plans to be a paleontologist, and the younger is in his first year at Columbia University, my alma mater, although sadly he is doing it from home thanks to the pandemic. We live in Shaker Heights. In pre-pandemic times, I sang and acted occasionally in [community theater](https://github.com/THOMASELOVE/theater), and now I read plays occasionally over Zoom.

## Email 

- Email to get help with the course: **500-help at case dot edu** (seen by Professor Love and the TA, Wyatt Bensken)
- `Thomas dot Love at case dot edu` (for matters related to grades or individual concerns)
- Professor Love is available for 15 minutes before and 15 or more minutes after class to chat.
...
I haven't been to either of my offices since March 2020. As of 2021-02-01, I've not been vaccinated against COVID-19, and I don't expect to be back in either office in the Spring semester.
