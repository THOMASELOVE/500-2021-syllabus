...
All deadlines are specified on [the Course Calendar](https://thomaselove.github.io/500/calendar.html).
...
Instructions and supplemental materials for the Course Project [are available here](https://thomaselove.github.io/500/project.html).
...
Instructions and supplemental materials for the OSIA work [are available here](https://github.com/THOMASELOVE/500-2021/tree/master/osia).

## Lab Assignments

Five lab assignments require you to do some analyses (using R and R Markdown) on data I will provide to you. 

Details on the lab assignments [are available here](https://github.com/THOMASELOVE/500-2021/tree/master/labs).
...
The essay prompts [are available here](https://github.com/THOMASELOVE/500-2021/tree/master/essays).
